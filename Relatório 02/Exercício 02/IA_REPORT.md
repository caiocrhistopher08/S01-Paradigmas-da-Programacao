...
A revisão ajudou a confirmar o preenchimento da tabela com entradas do usuário e a lógica da função `contarOcorrencias`. O contador só aumenta quando o elemento atual é igual ao valor procurado, e a função retorna apenas a quantidade encontrada. Esse padrão é útil para outros problemas de contagem em tabelas.
